import java.util.Random;
	...
	public class MMM {
        ...
        while(k<=10) { //Podemos usar un ciclo for o while, por comodidad usaremos while
			...
			//de otra forma es non y va actualizando el valor de la variable
                pares += num;
            } else {
                nones += num;
            }
		...
		if(pares==nones){
			...
			if (pares>nones){
				System.out.println("Ganaron los pares, la diferencia entre ellos es de " + parg);
					...
					System.out.println("Ganaron los nones, la diferencia entre ellos es de "+ nong);
					}
		}
    }
}
